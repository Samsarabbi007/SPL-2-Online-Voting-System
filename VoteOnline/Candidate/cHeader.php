...
<nav class="navbar navbar-expand-sm  bg-dark navbar-dark">
  ...
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link" href="Candidate.php">Home</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="cupdate.php">Profile</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="../Vote/result.php?results">Result</a>
    </li> 
    <li class="nav-item">
      <a class="nav-link" href="candidateCast.php">Vote</a>
    </li> 
    <li class="nav-item">
