...
<div class="container">
    <div class="row">
        <div class="col-sm-5" style="background-color: ; border-radius: 10px;">   
          <h3>Candidate sign up page of Online Voting System</h3>
        ...
        <div class="col-sm-6" style="background-color: aquamarine; margin-left: auto; border-radius: 10px">
             ...
             <table class="table">
                <form id="design" action="csignup.inc.php" method="post">
                    <tr>
                    ...
                    <tr>
                        <th></th>
                        <td><button type="submit" class="btn btn-info form-control" name="signup-submit">Submit</button></td>
                    </tr>   
                </form>
            </table>
            ...
            <?php
                  if (isset($_GET['error']))
                  {
                    ...
                    {
                      echo '<p><b>This username is already exist</b></p>';
                    }
