...
<div class="container">
    <div class="row">
      <div class="col-sm-11" style="background: ; border-radius: 20px;  margin-left: 5%">
          <br><h2 align="center">Eelection Candidates</h2>
          <table class="table">
             <thead>
                 <tr>
                     <th>ID</th>
              ...
              while($row = mysqli_fetch_assoc($result)){ ?>
                 <tr>
                     ...
                     <td>
                         ...
                         <a class="btn btn-warning btn-sm"  href="approveCandidate.php?id=<?php echo $row['id'];?>"><?php echo $row['status']?></a>
                         <a class="btn btn-danger btn-sm"   href="deleteCandidate.php?id=<?php echo $row['id'];?>" 
