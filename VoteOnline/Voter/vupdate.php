<?php
    ...
    if (isset($_POST['upload']))
    {
          ...
          {
             move_uploaded_file($file_tmp,"VoterImage/".$file_name);
             echo "Success";
             ...
             {
                $sql = "UPDATE voter_image SET image = '$file_name', text ='$text' WHERE id = $id"; 
                mysqli_query($connection, $sql);
             }
             else
             {
                $sql = "INSERT INTO voter_image(id, image, text) VALUES ($id, '$file_name', '$text')"; 
                mysqli_query($connection, $sql);              
             }
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-5" style="background-color: antiquewhite; border-radius: 10px; border: 1px solid #cbcbcb;">
          ...
          <?php 
           ...
           ?> 
            ...
            <form action="vupdate.php" method="post" enctype="multipart/form-data" style="width:80%; margin: 20px auto; border: 1px solid #cbcbcb;">
        ...
        <div class="col-sm-6" style="background-color: antiquewhite; margin-left: auto; border-radius: 10px; border: 1px solid #cbcbcb;">
             ...
             <table class="table">
                <form id="design" action="vupdate.inc.php" method="post">
                    <tr>
                        <th class="text-center">Name: </th>
                        <td><input type="text" name="uid" value="<?php echo $voter['username']; ?>" class="form-control"></td>
                    </tr>
                    <tr>
                        <th class="text-center">Email: </th>
                        <td><input type="email" name="email" value="<?php echo $voter['email']; ?>" class="form-control"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="address" value="<?php echo $voter['address'];?>" placeholder="Optional" class="form-control"></td>
                    </tr>
                    <tr>
                        <th class="text-center">Contact no: </th>
                        <td><input type="text" name="contact" placeholder="Optional" value="<?php echo $voter['contact'];?>" class="form-control"></td>
                    </tr> 
                    <tr>
                        <th></th>
